...
- The wrapper exports `HERMES_BUNDLED_SKILLS`, `MAIA_OPTIONAL_SKILLS`, and `MAIA_MANAGED=homebrew` so packaged installs keep runtime assets and defer upgrades to Homebrew.
