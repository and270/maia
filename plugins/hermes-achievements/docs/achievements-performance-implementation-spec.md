...
Storage path:
- `~/.maia/plugins/hermes-achievements/scan_snapshot.json`
...
Checkpoint file (new):
- `~/.maia/plugins/hermes-achievements/scan_checkpoint.json`
...
- persisted runtime files:
  - `~/.maia/plugins/hermes-achievements/state.json` (existing unlock state)
  - `~/.maia/plugins/hermes-achievements/scan_snapshot.json` (new)
  - `~/.maia/plugins/hermes-achievements/scan_checkpoint.json` (new)
