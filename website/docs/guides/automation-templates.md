...
hermes cron create "0 2 * * *" \
  "You are a project manager triaging the andreloureiro/coorporate-hermes GitHub repo.

1. Run: gh issue list --repo andreloureiro/coorporate-hermes --state open --json number,title,labels,author,createdAt --limit 30
...
hermes cron create "0 9 * * 1" \
  "Scan the andreloureiro/coorporate-hermes repo for documentation drift.

1. Run: gh pr list --repo andreloureiro/coorporate-hermes --state merged --json number,title,files,mergedAt --limit 30
