...
Maia automatically discovers and loads context files that shape how it behaves. Some are project-local and discovered from your working directory. `SOUL.md` is now global to the Hermes instance and is loaded from `MAIA_HOME` only.
...
| **SOUL.md** | Global personality and tone customization for this Hermes instance | `MAIA_HOME/SOUL.md` only |
...
- `~/.maia/SOUL.md`
- or `$MAIA_HOME/SOUL.md` if you run Hermes with a custom home directory
