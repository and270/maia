...
4. Name the token (e.g., "Maia"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.maia/.env`:
...
```bash
CANVAS="python $MAIA_HOME/skills/productivity/canvas/scripts/canvas_api.py"
