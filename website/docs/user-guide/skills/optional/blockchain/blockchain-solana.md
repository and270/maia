...
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Maia |
| License | MIT |
...
Helper script path: ~/.maia/skills/blockchain/solana/scripts/solana_client.py
...
python3 ~/.maia/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python3 ~/.maia/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python3 ~/.maia/skills/blockchain/solana/scripts/solana_client.py price BONK
python3 ~/.maia/skills/blockchain/solana/scripts/solana_client.py price JUP
python3 ~/.maia/skills/blockchain/solana/scripts/solana_client.py price SOL
python3 ~/.maia/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
