...
Add the `github-pr` route to your `~/.maia/config.yaml` as shown in the example above.
...
- Subscriptions are stored in `~/.maia/webhook_subscriptions.json`
