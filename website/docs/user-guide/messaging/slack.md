...
[`COMMAND_REGISTRY`](https://github.com/andreloureiro/coorporate-hermes/blob/main/hermes_cli/commands.py)
...
| **Channels** | Bot **only responds when @mentioned** (e.g., `@Coorporate Hermes what time is it?`). In channels, Hermes replies in a thread attached to that message. |
