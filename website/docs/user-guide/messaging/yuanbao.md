...
sidebar_position: 16
title: "Yuanbao"
description: "Connect Maia to the Yuanbao enterprise messaging platform via WebSocket gateway"
---
...
After initial setup, verify these variables in `~/.maia/.env`:
...
4. Review gateway logs: `tail -f ~/.maia/logs/gateway.log`
