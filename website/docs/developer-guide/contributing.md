...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Maia — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Maia! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.maia/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.maia` — use `get_hermes_home()` from `hermes_constants` for code paths and `display_hermes_home()` for user-facing messages. See [AGENTS.md](https://github.com/and270/maia/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- Use [GitHub Issues](https://github.com/and270/maia/issues)
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/and270/maia/blob/main/LICENSE).
