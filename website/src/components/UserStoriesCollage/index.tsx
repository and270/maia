  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Coorporate Hermes community is actually building. Every tile
      ...
      <div className={styles.footer}>
        Built something with Coorporate Hermes?{' '}
        <a
        ...
        to share a deployment story or request an enterprise onboarding review.
      </div>
    </div>
  );
}
