...
_HERMES_CORE_TOOLS = [
    ...
    "terminal", "process",
    # File manipulation
    "read_file", "write_file", "replace_file", "patch", "search_files",
...
TOOLSETS = {
    ...
    "messaging": {
        "description": "Cross-platform messaging and governed Maia administration",
        "tools": ["send_message", "maia_admin"],
        "includes": []
    },
    ...
    "file": {
        "description": "File manipulation tools: read, write text, promote generated/binary files, patch, and search",
        "tools": ["read_file", "write_file", "replace_file", "patch", "search_files"],
        "includes": []
    },
