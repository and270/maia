...
@pytest.mark.skip(
    reason="Maia has not yet ported the file_tools cross-profile/mirror "
    "soft-guard wiring (_check_cross_profile_path); only the "
    "agent.file_safety classification helpers are ported so far."
)
