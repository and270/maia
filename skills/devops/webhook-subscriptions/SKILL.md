...
- Subscriptions persist to `~/.maia/webhook_subscriptions.json`

## How It Works

1. `hermes webhook subscribe` writes to `~/.maia/webhook_subscriptions.json`
...
3. **Check gateway logs:** `grep webhook ~/.maia/logs/gateway.log | tail -20`
