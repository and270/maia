...
_DOCS_BASE = "https://github.com/andreloureiro/coorporate-hermes/tree/main/website/docs"
...
def _setup_slack():
    ...
    print()
    print_info("   Full guide: https://github.com/andreloureiro/coorporate-hermes/tree/main/website/docs/user-guide/messaging/slack/")
    print()
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://github.com/andreloureiro/coorporate-hermes/tree/main/website/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://github.com/andreloureiro/coorporate-hermes/tree/main/website/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
    print_info("   Open config in your editor:  hermes config edit")
    print_info("   Open config in your editor:  hermes config edit")
