...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Maia"                  # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Maia "         # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Maia"
...
- ``default`` — Classic Maia gold/kawaii (the current look)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Maia — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Maia",
            "welcome": "Welcome to Maia! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Maia ",
            "prompt_symbol": "❯",
