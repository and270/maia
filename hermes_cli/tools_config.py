...
def _run_post_setup(post_setup_key: str):
    ...
    if post_setup_key in ("agent_browser", "browserbase"):
        ...
        if _running_in_docker():
            ...
            _print_info(
                "      docker pull ghcr.io/and270/coorporate-hermes:latest"
            )
            return
...
def tools_command(args=None, first_install: bool = False, config: dict = None):
    ...
    print(color("  Guide: https://github.com/and270/coorporate-hermes/tree/main/website/docs/user-guide/features/tools", Colors.DIM))
    print()
