...
HERMES_AGENT_HELP_GUIDANCE = (
    "If the user asks about configuring, setting up, or using Maia "
    "itself, load the `hermes-agent` skill with skill_view(name='hermes-agent') "
    "before answering. Docs: https://ampliia.com/en/"
)
...
FILE_APPROVAL_GUIDANCE = (
    ...
    "eligible writer in a shared thread. If `approver_mention_text` is present, "
    "copy that exact platform markup into the response without paraphrasing it "
    "as a user ID or display label. If the current session is not marked "
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "or troubleshoot Maia itself — its CLI, config, models, providers, tools, "
