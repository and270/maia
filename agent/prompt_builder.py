...
DEFAULT_AGENT_IDENTITY = (
    "You are Coorporate Hermes, an intelligent AI assistant by AmpliIA. "
...
HERMES_AGENT_HELP_GUIDANCE = (
    "If the user asks about configuring, setting up, or using Coorporate Hermes "
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "or troubleshoot Coorporate Hermes itself — its CLI, config, models, providers, tools, "
